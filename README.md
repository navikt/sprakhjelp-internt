...
Språksjekk resultatene vises i Accordion elementet. Alt den trenger er {value}, det vil si tekstinnhold som kan analyseres. Du kan f.eks. hente dette fra et "teaxtarea" eller "input" element.
